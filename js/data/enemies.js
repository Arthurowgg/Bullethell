...
export const ENEMIES = {
  ...
  chitauri: {
    id: 'chitauri', shot: 'shot_en_chitauri', name: 'CHITAURI CORROMPIDO', sprite: 'en_chitauri', spriteB: 'en_chitauri_b',
  ...
  jotun: {
    id: 'jotun', shot: 'shot_en_jotun', name: 'FERA DE JOTUNHEIM', sprite: 'en_jotun', spriteB: 'en_jotun_b',
